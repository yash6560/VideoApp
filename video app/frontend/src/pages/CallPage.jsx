  ...
  useEffect(() => {
    const initCall = async () => {
      ...
      try {
        ...
        const videoClient = new StreamVideoClient({ apiKey: import.meta.env.VITE_STREAM_API_KEY, user, token : tokenData.token });
        ...
        console.error('Error initializing call page:', error);
      ...
      <div className='relative'>
        {client && call ? (
          ...
          <div className=" flex items-center justify-center h-full">
            <p>Could not initialized call. Please Try again later.</p>
          </div>
        )}  
      </div>
    </div>
